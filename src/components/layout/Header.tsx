...
export const Header = ({ search }: HeaderProps) => {
  return (
    <header className="fade-black-gradient-180 sticky top-0 z-30 mx-auto grid min-h-[70px] w-full grid-cols-7 items-start py-4">
      <div className="flex items-center self-center">
        <h1 className={clsx(logoFont.variable, 'font-logo text-3xl font-black')}>filmq</h1>
      </div>
      <div className="col-span-3 col-start-3 mx-4 hidden lg:block">{search ? search : null}</div>
      <div className="col-span-2 col-start-6 hidden items-center self-center lg:flex">
